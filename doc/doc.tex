...
\section{Conceptual Framing of Emotion}

Emotion in text can be interpreted in multiple ways:

\begin{itemize}
    \item \textbf{Writer-internal emotion:} the actual psychological state of the author at the time of writing.
    \item \textbf{Expressed emotion:} the emotion conveyed or expressed in the text.
    \item \textbf{Reader-evoked emotion:} the emotion elicited in the reader.
\end{itemize}
...
Therefore, this project models \emph{perceived expressed emotion}, rather than attempting to infer the author's internal psychological state or the reader's emotional reaction.
